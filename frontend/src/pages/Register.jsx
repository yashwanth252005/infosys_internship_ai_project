                ...
                <div className="p-8 md:p-10 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Start your smart dog care journey today
                        </p>
                    </motion.div>

                    {/* Google Signup (UI ready) */}
                    <motion.button
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.4 }}
                    ...
                    >
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition"
                            />
                        </div>
                        ...
                        <motion.button
                            ...
                            className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-indigo-700 text-white font-semibold shadow-lg hover:shadow-xl transition disabled:opacity-50"
                        >
